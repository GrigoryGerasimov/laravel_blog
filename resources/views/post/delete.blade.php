...
@section('content')
    <div class='row'>
        <form class='form' action="{{ route('post.destroy', $post) }}" method='POST'>
            @csrf
            @method('delete')
            <div class='input-group mb-3'>
                <label class='form-label col-1' for='title'>Title</label>
                <input class='form-input col-11 border-0 border-bottom' id='title' name='title' placeholder='Title' value="{{ $post->title }}" readonly/>
            </div>
            <div class='input-group mb-3'>
                <label class='form-label col-1' for='author'>Author</label>
                <input class='form-input col-11 border-0 border-bottom' id='author' name='author' placeholder='Author' value="{{ $post->author }}" readonly/>
            </div>
            <div class='input-group mb-3'>
                <label class='form-label col-1' for='image'>Image</label>
                <input class='form-input col-11 border-0 border-bottom' id='image' name='image' placeholder='URL' value="{{ $post->image }}" readonly/>
            </div>
            <div class='input-group mb-3'>
            ...
            <div class='input-group mb-3 h-100'>
                ...
                <textarea class='form-input col-11 h-auto border-0 border-bottom' id='content' name='content' placeholder='Your message...' readonly>{{ $post->content }}</textarea>
            </div>
