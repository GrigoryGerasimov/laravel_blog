    ...
    <div class='row'>
        <form class='form' action="{{ route('post.store') }}" method='POST'>
            ...
            <div class='input-group mb-3'>
                ...
                <input class='form-input col-11 border-0 border-bottom' id='title' name='title' placeholder='Title' value="{{ old('title') }}"/>
                @error('title')
            ...
            <div class='input-group mb-3'>
                ...
                <input class='form-input col-11 border-0 border-bottom' id='author' name='author' placeholder='Author' value="{{ old('author') }}"/>
                @error('author')
                <span class='text-danger'>{{ $message }}</span>
                @enderror
            </div>
            <div class='input-group mb-3'>
                ...
                <input class='form-input col-11 border-0 border-bottom' id='image' name='image' placeholder='URL' value="{{ old('image') }}"/>
                @error('image')
                <span class='text-danger'>{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class='input-group mb-3 h-100'>
                ...
                <textarea class='form-input col-11 h-auto border-0 border-bottom' id='content' name='content' placeholder='Your message...'>{{ old('content') }}</textarea>
                @error('content')
                <span class='text-danger'>{{ $message }}</span>
                @enderror
            </div>
