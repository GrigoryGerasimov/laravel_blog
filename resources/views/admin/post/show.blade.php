    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            ...
            <div class="mt-4 d-flex flex-row justify-content-between align-items-center">
                <a class="card-link" style="color:#fff!important" href="{{ route('admin.post.index') }}">
                ...
                <div class="d-flex flex-row justify-content-center">
                    <a class="card-link mx-5" style="color:#fff!important" href="{{ route('admin.post.edit', $post) }}"><small>Edit</small></a>
                    <a class="card-link" style="color:#fff!important"
                       href="{{ route('admin.post.delete', $post) }}"><small>Delete</small></a>
                </div>
            </div>
