            ...
            @foreach ($postsList as $post)
                <div class="card mb-5" style="width: 48%">
                    <div class="row g-0 h-100">
                        <div class="col-md-5">
                            <img src="{{ $post->image }}" class="img-fluid rounded-start h-100"
                                 alt="post {{ $post->id }} photo">
                        </div>
                        <div class="col-md-7">
                            <div class="card-body d-flex flex-column flex-wrap justify-content-between h-100">
                                ...
                                <p class="card-text d-flex justify-content-end"><small class="text-muted">Last
                                        updated {{ $post->updated_at }}</small></p>
                            </div>
                        </div>
                    </div>
                </div>
